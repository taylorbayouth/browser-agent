...
// driving input), then reuses transient visual evidence or hands the image to
// the configured vision model. The returned summary/description ride back as the
// Observation's `detail`: the loop keeps the short summary in prompt history and
// saves the full description with the image artifact.
//
