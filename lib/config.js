...
const DEFAULTS = {
  ...
  visualEvidence: {              // pre-brief vision pass over unreadable @r regions
    enabled: true,               // classify @r as visual/text/unknown before planning
    maxRegions: 8,               // cap expensive crop+vision calls per extracted brief
  },
