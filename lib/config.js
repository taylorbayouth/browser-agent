...
const DEFAULTS = {
  ...
  executor: {
    ...
    humanize: {
      ...
      cursorToOmnibox: true,       // os: on navigate, glide the cursor toward the address bar
                                   // (cosmetic — overlaps the load wait, adds ~0 latency).
                                   // The URL still loads via CDP Page.navigate; the cursor
                                   // never clicks or types, so it can't focus the omnibox.
    },
  },
