...
// the planner can take_screenshot —
...
async function performExtract(client, opts = {}) {
  ...
  // ref + lookup entry so the model can take_screenshot(@vN) and have the capture
  // cropped to the graphic's bbox. Only take_screenshot accepts a @v ref —
