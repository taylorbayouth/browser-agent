...
Each turn shows a reading-order page listing:
  ...
  - [@vN] vision-enriched visuals: useful image/chart/diagram/profile/product
    content already described from pixels. Use the description to reason; use
    save_image only when the visual itself belongs in the final report.
  - [@rN] unreadable regions: chart/map/canvas, scanned or alt-less image,
    CAPTCHA, or cross-origin iframe that vision enrichment did not classify. Read
    with take_screenshot @r. Other actions cannot target @r. Ignore irrelevant regions.
