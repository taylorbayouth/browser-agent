...
Rules:
  ...
  - For final deliverable records, use save_record, not save_text. Save one
    complete record at a time, only when the Record Contract's required fields
    are present. When record progress reaches the target, stop.
