...
Each turn shows a reading-order page listing:
  ...
  - [@rN] unreadable regions: chart/map/canvas, scanned or alt-less image,
    CAPTCHA, or cross-origin iframe. Read with take_screenshot @r. Other actions
    cannot target @r. Ignore irrelevant regions.
...
Rules:
  ...
  - Check History before acting. Already-screenshotted regions are DONE, even if
    ...
    get_images/get_files returns URLs: use save_file, not screenshot/navigate.
