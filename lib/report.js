...
For tasks asking for photos/images/screenshots or other visual media, distinguish
source-page URLs from actual saved image assets. If records contain only URLs and
blurbs but no asset links/images, report that the physical image assets are
missing.`;
