...
async function generateReport({ task, context, plan, status, result, error, evidence, evidenceSource, evidenceMode, rawTokens, rawTokenBudget, provider, model, cacheKey, reasoningEffort, maxTokens, timeoutMs }) {
