...
const ACTIONS = {
  ...
  take_screenshot: {
    ...
    changesPage: false,
    idempotentRead: true,
    description: 'Capture; vision describes/saves it. No ref = visible viewport. To crop, pass exact visible @e/@t/@r; never pass punctuation, CSS selectors, words, or coordinates as ref. Best for charts, diagrams, canvas, scans, CAPTCHA. Images with URLs: use save_file. hint focuses description.',
  },
  get_images: {
    requiresRef: false,
    args: {},
    changesPage: false,
    idempotentRead: true,
    description: 'List page images absent from element listing: URL, caption, size, position. Then save_file(url); do not screenshot to verify.',
  },
  get_files: {
    requiresRef: false,
    args: {},
  ...
  save_file: {
    ...
    changesPage: false,
    description: 'Download/save URL from get_images, get_files, or visible link. Images get vision description; other files get name/type/size. hint focuses image description.',
  },
  save_record: {
    requiresRef: false,
