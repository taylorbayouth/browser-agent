...
const ACTIONS = {
  ...
  save_image: {
    ...
    args: { hint: 'string?' },
    changesPage: false,
    description: 'Save an image into report assets. Use @r for an unreadable visual region, @e/@t for a crop, or no ref for the viewport. Use only when the visual itself belongs in the final report.',
  },
  save_record: {
    requiresRef: false,
