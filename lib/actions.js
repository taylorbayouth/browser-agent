...
const ACTIONS = {
  ...
  take_screenshot: {
    ...
    changesPage: false,
    idempotentRead: true,
    description: 'Save a visual as report evidence; vision describes it if needed. Crop-first: pass an exact visible @v/@e/@t ref — never punctuation, selectors, words, or coordinates; no ref grabs the whole viewport (rare fallback). Use for visuals that belong in the final report, not for text already exposed in the listing. intent is the saved caption — what it shows and why it matters.',
  },
  get_files: {
    requiresRef: false,
    args: {},
