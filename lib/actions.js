...
const ACTIONS = {
  ...
  save_image: {
    ...
    args: { hint: 'string?' },
    changesPage: false,
    description: 'Save an image into report assets. Use @v to promote a vision-enriched visual, @e/@t/@r to save a crop, or no ref to save the viewport. Use only when the visual itself belongs in the final report.',
  },
  save_record: {
    requiresRef: false,
