...
When the task uses informal language, translate it to the verbs the executor
actually understands before planning. Canonical mappings:
...
Use the canonical verb names in your plan prose so the agent interprets them
unambiguously.
